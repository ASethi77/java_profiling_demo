...
class LeakyArrayAdder extends RecursiveTask<Integer>
{
    private static List<int[]> compute_logs = new ArrayList<int[]>();
    ...
    LeakyArrayAdder(int[] arr, int startIndex, int endIndex, boolean balanced, boolean copy)
    {
        if (copy) {
        ...
        compute_logs.add(arr);
    }

    LeakyArrayAdder(int[] arr, int startIndex, int endIndex, boolean balanced)
    {
        this(arr, startIndex, endIndex, balanced, false);
    }

    LeakyArrayAdder(int[] arr, int startIndex, int endIndex)
    {
